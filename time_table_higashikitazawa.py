...
#    draw.text((20, 40), "Temp_high:", font = font15, fill = 0)
    ...
    draw.text((10, 50), "新宿:", font = font15, fill = 0)
    draw.text((80, 50), str(dt_now.hour), font = font20, fill = 0)
    draw.text((130, 50), str(transit_time_shinjuku_min_now_1), font = font20, fill = 0)
    draw.text((160, 50), str(transit_time_shinjuku_min_now_2), font = font20, fill = 0)
    draw.text((190, 50), str(transit_time_shinjuku_min_now_3), font = font20, fill = 0)
    draw.text((10, 80), "本厚木:", font = font15, fill = 0)
    draw.text((80, 80), str(dt_now.hour), font = font20, fill = 0)
    draw.text((130, 80), str(transit_time_atsugi_min_now_1), font = font20, fill = 0)
    draw.text((160, 80), str(transit_time_atsugi_min_now_2), font = font20, fill = 0)
    draw.text((190, 80), str(transit_time_atsugi_min_now_3), font = font20, fill = 0)
