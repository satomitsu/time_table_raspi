...
try:
    ...
    #電車時刻表示
    transit = soup_transit.select('#main > div.mainWrp > div.mdStaLineDia > div.elmLineDia > table.tblDiaDetail > tr.hh_5 > td > ul > li', string=lambda text: "python" in text.lower())
    #天気の表示
